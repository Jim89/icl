---
title: "Advanced Analytics and Machine Learning Project"
subtitle: "An analysis of Hilary Clinton's emails"
author: "Jim Leach"
output: 
    html_document:
        code_folding: hide
...
```{r script, message = FALSE, warning = FALSE, include = FALSE}
# Load packages
library(readr)
library(dplyr)
library(tidyr)
...
source("./r/functions/plot_network.R")
...
## This is a tabset test {.tabset}

### Walktrap

```{r}
plot_network(graph, "walk")
```

### Betweenness
```{r}
plot_network(graph, "bet")
```
