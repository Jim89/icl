...
twCorpus[["device"]] <- ifelse(grepl("Android", twCorpus[["statusSource"]]), "Android",
                               ifelse(grepl("iPhone", twCorpus[["statusSource"]]), "iPhone",
                                    ifelse(grepl("Web Client", twCorpus[["statusSource"]]), "Web", NA)))
