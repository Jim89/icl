...
The max-cost spanning tree and Dijkstra algorithms were programmed in Python. The code is presented here, and is also found in the two attached files `max_cost_st.py` and `dijkstra.py`.