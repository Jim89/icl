...
## Bipartite graphs and simple matching
...
One possible solution to this problem is to use linear programming (or other combinatorial algorithm). If $A$ is the node-edge incidence matrix of a bipartite graph then we can formulate this as:
