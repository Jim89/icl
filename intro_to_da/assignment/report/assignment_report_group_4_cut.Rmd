...
This was done as, for two IDs with the same mean Jaccard distance, a higher flexibility score should be assigned to the ID that made 6 picks in each network than the ID that made 1 pick in each network.
...
In this way the two methods are relatively similar. Whilst the weighting for the "picks proportion" is qualitatively sensible, it does not have a significant impact on the quantitative results and does not necessarily constitute a "better" result.
