...
# TO DO!!!!!!!!
# THE PACKAGE test-helper must be installed on all node : "sudo pip-2.7 install test_helper"

# You need to run the blocks of code through pyspark one after the other and Replace <FILL IN> with appropriate code.
...
logFile = "input/apache.access.log"
...
print ('Content size Avg: ', content_sizes.reduce(lambda a, b : a + b)/content_sizes.count(),'Min: ', content_sizes.min(), 'Max: ', content_sizes.max())
...
print('Response Code Counts: ', responseCodeToCountList)
