...
objects <- ls()
idx <- grep("tidy_mlogit|coffee_clean|coffee_wide|coffee_long|elasticities|theme_jim|toproper|ggally_cor|check_class|check_length|check_type|coalesce|replace_with", objects)
objects <- objects[-idx]
