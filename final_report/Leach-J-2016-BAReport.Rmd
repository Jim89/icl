...
The data for the graph structure [@wikimedia_london_2009] and the distances between adjacent stations [@tfl_distances_2013] (in km) were loaded and some basic processing and cleaning (e.g. standardising the names of stations) was performed.
