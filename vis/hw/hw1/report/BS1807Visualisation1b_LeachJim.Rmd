...
* There are no "canooing" events until the 1936 games, similarly, there are no rowing events for the 1896 games.
...
* Provide a lookup of standardised country codes to country _names_ for more readable labelling.
* Add data on other countries participating in games/events.
* Add athlete net worth/event winnings.
* Add athlete age/race/height/weight/other physical characteristics.
...
In this section I present a list of editorial perspectives that I have come up with whilst examining the data.

## 1 - 100m race times over time

* __Angle__: Fastest/winning time in the 100m sprint, split by men and women.
* __Framing__: All 100m sprints held in summer Olympics games between 1928 and 2012. Both men's _and_ women's are shown.
